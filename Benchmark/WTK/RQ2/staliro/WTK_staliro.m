...
if ismac() == 1
    ...
    addpath(genpath('/Users/quandoan/Documents/MATLAB/AI-CPS-Benchmark/Benchmark/WTK/'));
elseif isunix() == 1
    % Linux
...
mdl_list = {'WTK_T_staliro'}; % ,'WTK_RL_hybrid_staliro','WTK_RL_hybrid_random_01_staliro','WTK_RL_hybrid_average_staliro'}; % 'WTK_RL','WTK_PID'
% agent list
...
for solver_index = 1:numel(solver_list)
    ...
    for mdl_index = 1:numel(mdl_list)
        ...
        if strcmp(cur_mdl,'WTK_T_staliro')
            % falsification
