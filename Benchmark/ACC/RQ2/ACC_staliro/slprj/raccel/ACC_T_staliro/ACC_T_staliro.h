...
gynr2znndm ; real_T htwgdyzcn2 ; real_T n0d5e2ho2i ; real_T orrovtgqjg ;
real_T pek2dwwobf ; real_T dsq5zwnmgo ; real_T kdw2tjpjdg ; real_T ilwh5fwuw1
[ 2 ] ; real_T efgc5lqpni ; real_T pxpdmw0bcs ; real_T iclkc1kaku [ 4 ] ;
real_T lyecgqqwmf ; boolean_T ett04lmlns [ 96 ] ; duxnsc5qxr p4e11kbpcn ;
bb1fpji5wu a1wp4jzqbg ; bb1fpji5wu gh105iynfl ; bb1fpji5wu blt3cbb5h0 ;
bb1fpji5wu oole0kyrzs ; duxnsc5qxr g1gdocpcgl ; duxnsc5qxr f4esyblzdq ;
duxnsc5qxr ka5gqtv0zq ; duxnsc5qxr iycis3sksg ; } B ; typedef struct { real_T
g2rfivpzu1 ; real_T ldwnfqj2nl [ 4 ] ; struct { void * AQHandles ; }
fbqs3m1xnv ; struct { void * LoggedData ; } pqhmcoehms ; struct { void *
...
DataMapInfo ; struct P_ { real_T D_default ; real_T t_gap ; real_T v0_ego ;
real_T v0_lead ; real_T v_set ; real_T x0_ego ; real_T x0_lead ; real_T
AdaptiveCruiseControlSystem_MaxAcceleration ; real_T
AdaptiveCruiseControlSystem_MaxVelocity ; real_T
AdaptiveCruiseControlSystem_MinAcceleration ; real_T Integrator1_IC ; real_T
