...
MODEL                   = ACC_T_staliro
MODULES                 = ACC_T_staliro.c ACC_T_staliro_capi.c ACC_T_staliro_data.c ACC_T_staliro_tgtconn.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = ACC_T_staliro
MAKEFILE                = ACC_T_staliro.mk
MATLAB_ROOT             = /Applications/MATLAB_R2024b.app
ALT_MATLAB_ROOT         = /Applications/MATLAB_R2024b.app
START_DIR               = /Users/quandoan/Documents/MATLAB/AI-CPS-Benchmark/Benchmark/CSTR/RQ2/CSTR_staliro
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 7
COMPUTER                = MACA64
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/ACC_T_staliro \
