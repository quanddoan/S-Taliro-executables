...
if ismac() == 1
    % MacOS
    addpath(genpath('/Users/quandoan/Documents/MATLAB/AI-CPS-Benchmark/tools/S-TaLiRo/root/trunk'));
    addpath(genpath('/Users/quandoan/Documents/MATLAB/AI-CPS-Benchmark/Benchmark/CSTR'));
elseif isunix() == 1
    % Linux
...
mdl_list = {'CSTR_T_staliro'}; %,'CSTR_hybrid_random_01_staliro', 'CSTR_hybrid_random_1_staliro', 'CSTR_hybrid_average_staliro'};
% agent list
...
for solver_index = 1:numel(solver_list)
    ...
    for mdl_index = 1:numel(mdl_list)
        ...
        if strcmp(cur_mdl,'CSTR_T_staliro')
            % falsification
