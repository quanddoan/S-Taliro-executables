...
MAKECMD         = /Applications/MATLAB_R2024b.app/bin/maca64/gmake -j 4 -l 8
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODULES                 = AbstractFuelControl_M1.c AbstractFuelControl_M1_capi.c AbstractFuelControl_M1_data.c AbstractFuelControl_M1_tgtconn.c rtGetInf.c rt_nonfinite.c rt_zcfcn.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = AbstractFuelControl_M1
...
START_DIR               = /Users/quandoan/Documents/MATLAB/AI-CPS-Benchmark/tools/S-TaLiRo/root/trunk/benchmarks/ARCH2017_Competition
S_FUNCTIONS_LIB         = 
NUMST                   = 3
NCSTATES                = 7
COMPUTER                = MACA64
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/AbstractFuelControl_M1 \
